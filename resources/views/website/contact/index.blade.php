...
@section('body')
            ...
            <div class="row row-cols-lg-3 row-cols-1">
                <div class="col">
                    <div class="contact-info">
                        ...
                        <div class="d-flex">
                            <div class="circle me-4"><img src="{{asset('/')}}website/assets/images/team/01.png" alt=""></div>
    ...
    <div class="full-row bg-white pt-0">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <form id="contact-form" class="w-100" action="https://template.unicoderbd.com/homex/email.php" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <button type="submit" id="send" value="send message" class="btn text-white rounded rounded-3"style="background-color: rgba(95, 98, 139, 1)"> Send Message</button>
                            </div>
                            <div class="col-lg-12">
